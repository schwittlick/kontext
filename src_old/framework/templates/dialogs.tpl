...
<div class="modal hide" id="netapi_fragment">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">×</button>
        <h3>Create recipe code</h3>
    </div>
    <div class="modal-body" style="min-height:400px">
        <div>
            <form id="netapi_fragment_form" class="form-horizontal well">
                <div class="control-group">
                    <p>
                        <label>
                            include world/worldadapter config:
                            <input type="checkbox" id="fragment_env" class="refresh_code"/>
                        </label>
                    </p>
                    <p>
                        <label>
                            include device config:
                            <input type="checkbox" id="fragment_devices"  class="refresh_code"/>
                        </label>
                    </p>
                    <p>
                        <label>
                            include state:
                            <input type="checkbox" id="fragment_state"  class="refresh_code"/>
                        </label>
                    </p>
                    <p>
                        <label for="fragment_recipe_name" class="inline">recipe name:</label>
                        <input class="refresh_code" type="text" id="fragment_recipe_name" value=""/>
                    </p>
                </div>
                <div class="control-group">
                    <textarea id="fragment_code" class="copy_paste_textbox" disabled="disabled">
                    </textarea>
                </div>
                <div class="control-group">
                    Save as a recipe:<br />
                    <input type="text" id="fragment_recipe_file_name"/>
                    <input type="submit" id="fragment_recipe_save" value="save"/>
                </div>
            </form>
        </div>
    </div>
